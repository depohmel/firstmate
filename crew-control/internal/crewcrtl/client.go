...
// file. It is part of the fork-local crew-control MCP server.
//
...
// DefaultFirstMateHome is the firstmate home directory, read from the FM_HOME
// environment variable. Override with the --fm-home flag. When neither is set,
// the individual paths (bin/, data/, state/) default to relative to the CWD.
