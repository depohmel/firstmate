...
// file. It is part of the crew-control-mcp addon in the firstmate fork.
//
...
// DefaultFirstMateHome is the firstmate home directory, resolved from the
// FM_HOME environment variable. If FM_HOME is not set, callers must provide
// --fm-home explicitly. This avoids hardcoding a machine-specific path.
var DefaultFirstMateHome = os.Getenv("FM_HOME")
